...
'''
        ...
        composition_root = '''from __future__ import annotations

from app.%s.application.services.dispute_service import DisputeApplicationService
...
def test_openapi_declares_local_generated_contract():
    ...
    assert (expected_endpoints - {"GET /openapi.json"}).issubset(_public_openapi_identities())
''' % app_id,
            f"app/{app_id}/application/ports.py": ports,
            f"app/{app_id}/application/composition_root.py": composition_root,
