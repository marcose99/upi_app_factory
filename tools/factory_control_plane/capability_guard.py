...
from tools.factory_control_plane.common import ControlPlaneError, resolve_under_root
...
class CapabilityGuard:
    ...
    def _register(self, item: object) -> None:
        ...
        if kind == "python_script":
            if item["executable"] != "/usr/bin/python3" or not isinstance(item["script"], str):
            ...
            if not executable.is_file():
                raise ControlPlaneError("canonical Python executable is unavailable")
